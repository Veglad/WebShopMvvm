...
import com.sigma.vshcheglov.webshop.presentation.detail.DetailActivity
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        with(productList[holder.adapterPosition]) {
            ...
            holder.view.productImage.contentDescription = String.format(
                holder.view.context.getString(com.sigma.vshcheglov.webshop.R.string.image_content_text_format),
                name
            )
            holder.view.saleTextView.text = String.format(
                holder.view.context.getString(com.sigma.vshcheglov.webshop.R.string.sale_format),
                percentageDiscount
            )
            holder.view.productTitle.text = name
            holder.view.productPrice.text = String.format(
                holder.view.context.getString(com.sigma.vshcheglov.webshop.R.string.price_format),
                price
            )
